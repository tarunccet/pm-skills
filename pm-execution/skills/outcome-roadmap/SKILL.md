...
2. **Identify gaps** — if any of the following are unclear, ask:
   - What is the current roadmap format (output-focused features list)?
   - What business outcomes or OKRs should the roadmap align to?
   - What time horizon are we working with?
