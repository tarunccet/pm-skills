...
Product discovery skills for PMs: ideation, experiments, assumption testing, and customer interview synthesis. Feature and assumption prioritization are now part of the unified `prioritization` skill in pm-execution. Product metrics are now in the `product-metrics` skill in pm-data-analytics.
