...
Vibe coding skills for PM-builders: write AI coding specs, plan prototypes, make technical decisions, review AI-generated code, and ship with confidence.

Built for PMs who are building products themselves using AI-assisted coding tools (Cursor, GitHub Copilot, Replit Agent, Claude Code, Bolt.new, etc.)
...
Skills:
- `Write a vibe spec for a simple CRM for freelancers`
- `Help me choose between Supabase and Firebase for my app`
- `Review the auth code my AI just generated`

Commands:
- `/vibe-spec A job board for climate tech roles`
- `/plan-prototype A waitlist page with referral tracking`
- `/tech-decision Should I use REST or GraphQL for my startup's API?`
- `/review-code The checkout flow my Cursor AI just wrote`
- `/deploy-check My Next.js + Supabase app before sharing with beta users`
- `/debug-help Error: Cannot read properties of undefined (reading 'user')`
