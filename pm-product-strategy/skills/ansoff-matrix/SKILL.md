...
2. **Identify gaps** — if any of the following are unclear, ask:
   - What product or business are we analyzing?
   - What are the current markets and product lines?
   - What is the growth objective or strategic question driving this analysis?
