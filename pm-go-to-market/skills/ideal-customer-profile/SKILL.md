...
2. **Identify gaps** — if any of the following are unclear, ask:
   - What product or service is this ICP for?
   - What customer data is available (interviews, surveys, usage data)?
   - Are there existing customer segments or hypotheses to validate?
...
If the user provides additional context, incorporate it. If the user confirms, proceed to Step 1 to gather the detailed customer data.
