...
1. **What stage of PM work are you in?**
   ...
   - 🚀 GTM (launch, growth loops, ICP)
   - 📣 Marketing (naming, positioning, marketing ideas)
   ...
   - 🛠️ Utilities (resume, NDA, grammar, datasets)
...
- **Strategy**: product-vision, product-strategy, value-proposition, lean-canvas, business-model, startup-canvas, swot-analysis, pestle-analysis, porters-five-forces, ansoff-matrix, monetization-strategy, pricing-strategy
...
- **Research**: user-personas, competitor-analysis, market-sizing, segmentation, sentiment-analysis, customer-journey-map
- **Analytics**: product-metrics, ab-test-analysis, cohort-analysis, sql-queries
- **GTM**: gtm-strategy, gtm-motions, growth-loops, ideal-customer-profile
- **Marketing**: marketing-ideas, positioning-ideas, product-name
